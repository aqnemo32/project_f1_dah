...
plt.title('xmass')
plt.savefig('/Users/achillequarante/Desktop/dah_graphs_project/ups_hist/mass_hist', format = 'png')
plt.clf()
...
plt.savefig('/Users/achillequarante/Desktop/dah_graphs_project/ups_hist/mom_pair_hist', format = 'png')
plt.clf()
...
plt.savefig('/Users/achillequarante/Desktop/dah_graphs_project/ups_hist/mom_tran_1_hist', format = 'png')
plt.clf()
...
plt.savefig('/Users/achillequarante/Desktop/dah_graphs_project/ups_hist/mom_tran_2_hist', format = 'png')
plt.clf()
...
plt.savefig('/Users/achillequarante/Desktop/dah_graphs_project/ups_hist/mom_tran_pair_hist', format = 'png')
plt.clf()
...
plt.title('Rapidity')
plt.savefig('/Users/achillequarante/Desktop/dah_graphs_project/ups_hist/rap_hist', format = 'png')
plt.clf()
